                ...
                */
                ...
                if ($category != 'Category') {
                    if ($orderBy == 'Price DESC') {
                        ...
                        $query = $conn->prepare("SELECT * FROM Inventory WHERE Category = ? ORDER BY Name");
                        $query->bindValue(1, $category, PDO::PARAM_STR);
                        //$query->bindValue(2, "$orderBy", PDO::PARAM_STR);
                    } else {
                        $query = $conn->prepare("SELECT * FROM Inventory WHERE Category = ? ORDER BY Price");
                        $query->bindValue(1, $category, PDO::PARAM_STR);
                    }
                } else {
                    if ($orderBy == 'Price DESC') {
                        ...
                        $query = $conn->prepare("SELECT * FROM Inventory WHERE Name LIKE ? ORDER BY Name");
                        $query->bindValue(1, "%$search%", PDO::PARAM_STR);
                        //$query->bindValue(2, $orderBy, PDO::PARAM_STR);
                    } else {
                        $query = $conn->prepare("SELECT * FROM Inventory WHERE Name LIKE ? ORDER BY Price");
                        $query->bindValue(1, "%$search%", PDO::PARAM_STR);
                    }
                }
